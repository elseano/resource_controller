...
Gem::Specification.new do |s|
  s.name = %q{resource_controller_views}
  s.version = "0.6.6.views1"

  s.required_rubygems_version = Gem::Requirement.new("> 1.3.1") if s.respond_to? :required_rubygems_version=
  s.authors = ["James Golick", "Sean St. Quentin", "Khamsouk Souvanlasy"]
  s.date = %q{2010-03-22}
  s.description = %q{}
  s.email = %q{james@giraffesoft.ca,sean@iproperty.com.au}
  s.extra_rdoc_files = [
    "LICENSE",
     "README.rdoc",
     "TODO"
  ...
  s.files = [
    "README.rdoc",
     ...
     "lib/resource_controller/helpers/pagination.rb",
     "lib/resource_controller/helpers/searchlogic.rb",
     "lib/resource_controller/helpers/singleton_customizations.rb",
     "lib/resource_controller/helpers/urls.rb",
     "lib/resource_controller/helpers/views.rb",
     "lib/resource_controller/partials.rb",
     "lib/resource_controller/response_collector.rb",
     "lib/resource_controller/singleton.rb",
     "lib/resource_controller/views.rb",
     "lib/urligence.rb",
     "rails/init.rb",
     "test/Rakefile",
     ...
     "test/app/views/people/_form.rhtml",
     "test/app/views/people/index.rhtml",
     "test/app/views/people/show.rhtml",
     "test/app/views/photos/_form.rhtml",
     "test/app/views/photos/_info.rhtml",
     ...
     "test/app/views/scaffold/edit.rhtml",
     "test/app/views/scaffold/new.rhtml",
  ...
  s.summary = %q{Rails RESTful controller abstraction plugin, with cascading views to keep them nice and DRY.}
  s.test_files = [
    "test/app/controllers/accounts_controller.rb",
     "test/app/controllers/application_controller.rb",
     "test/app/controllers/cms/options_controller.rb",
